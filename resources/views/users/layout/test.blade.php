        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title"><a href="#">Foysal</a> </li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                           
                             <li><i class="fa fa-money"></i><a href="ui-buttons.html">Manage Car Info</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ route('earn')}}">Earn</a></li>
                            <li><i class="fa fa-bars"></i><a href="{{ route('cost')}}">Cost</a></li>

                            <li><i class="fa fa-id-card-o"></i><a href="{{ route('driver')}}">Driver</a></li>
                            <li><i class="fa fa-exclamation-triangle"></i><a href="ui-alerts.html">Report</a></li>
